...
#ifndef P2P_SHARING_APP_SWIFT_H
#define P2P_SHARING_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="p2p_sharing_app",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC15p2p_sharing_app11AppDelegate")
...
SWIFT_CLASS("_TtC15p2p_sharing_app17MainFlutterWindow")
